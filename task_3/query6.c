...
//QUERY that filters out students who dont have negative marks
    ...
    if (db){                            
        ...
        for (int i = 0; i < size; ++i){ // process all the student records in database
            ...
            if(1){ // *** first filter, conditions on the student
                ...
                if (countNegativeMarks ==  0 && s.load != 0) {//
                    ++counterDemo; // counting students
				}
            }
        }
		printf("\033[0;32mQUERY6 [Students who dont have negative marks]:\033[0m\n");
