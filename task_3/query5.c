...
//QUERY that filters out students who have longer first names than last names
...
int main(int argc, char *argv[]) {
    ...
    if (db){                            
		...
		printf("\033[0;32mQUERY5 [Students who have longer first name than last name]:\033[0m\n");
